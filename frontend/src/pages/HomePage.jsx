...
const Homepage = () => {
  ...
  const handleExploreMore = (category) => {
    if (category !== "New Arrival") navigate(`/${category.toLowerCase()}`);
  };
  console.log(isLoading, "isisLoading");
    ...
    <Box mt={{ base: "20", lg: 0 }}>
      <Box maxW="80%" mx="auto" mt={12} p={6} bg="gray.100" rounded="md" mb={4}>
        ...
        <Text fontSize="lg" textAlign="center">
          Browse through our wide range of products and find the perfect items
          for yourself and your loved ones. Enjoy a seamless shopping experience
          and stay fashionable with us!
        </Text>
      </Box>
      <Divider mb={4} />
